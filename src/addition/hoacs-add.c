...
void print_hoacs_addition_demo() {
    printf("HOACS-Protected Addition Operations\n");
    printf("====================================\n\n");
    ...
    // Test cases for addition (same as regular)
    uint8_t a1 = 42, b1 = 17;
    ...
    Encoded c1_enc = AddEnc(a1_enc, b1_enc, m1, m2);
    ...
    Encoded c2_enc = AddEnc(a2_enc, b2_enc, m1, m2);
    printf("  Result (Encoded): c=(%u,%u)\n", c2_enc.u1, c2_enc.u2);
    ...
    Encoded c3_enc = AddEnc(a3_enc, b3_enc, m1, m2);
    printf("  Result (Encoded): c=(%u,%u)\n", c3_enc.u1, c3_enc.u2);
    ...
    Encoded c4_enc = AddEnc(a4_enc, b4_enc, m1, m2);
    printf("  Result (Encoded): c=(%u,%u)\n", c4_enc.u1, c4_enc.u2);
    ...
    Encoded c5_enc = AddEnc(a5_enc, b5_enc, m1, m2);
    printf("  Result (Encoded): c=(%u,%u)\n", c5_enc.u1, c5_enc.u2);
